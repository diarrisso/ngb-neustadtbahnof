...
<div class="container datenschutz">
    ...
    <div class="seconde-colounm">
        ...
        <p>
            <strong></strong> Hinweis zur verantwortlichen Stelle </strong> </p>
        <p>
            Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:
        </p>
        <ul>
            <li>Peper & Söhne GmbH</li>
            <li>Allerkai 4</li>
            <li>28309 Bremen</li>
            <li>Telefon: +49 421 45 855 29 – 0</li>
            <li><a href="malto:info@peperundsoehne.de">info@peperundsoehne.de</a></li>
        </ul>
    ...
    <div class="five-colunm">
        ...
        <p>
            ...
            Weitere Informationen zu Google Web Fonts finden Sie unter  <a href=" https://developers.google.com/fonts/faq "> https://developers.google.com/fonts/faq </a>
